...
if ($role == 'Admin') {
    $d_pasien = query("SELECT * FROM pasien");
} elseif ($role == 'Perawat') {
    $d_pasien = query("SELECT * FROM pasien WHERE user_id = $user_id");
}

$jumlahData = count($d_pasien);
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="">Data Pasien</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    <?php foreach ($d_pasien as $i => $pasien): ?>
                                        <tr>
                                            <td><?= $i + 1; ?></td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                                        ...
                                                        <a class="dropdown-item" href="edit_pasien.php?id_pasien=<?= $pasien["id_pasien"]; ?>">Input Gejala Pasien</a>
