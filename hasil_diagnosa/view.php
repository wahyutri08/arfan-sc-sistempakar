                                        ...
                                        <div class="col-md-3 col-12">
                                            <div class="form-group">
                                                ...
                                                <input
                                                    ...
                                                    class="form-control"
                                                    name="nama_pasien"
                                                    value="<?= $hasil["nama_pasien"] ?>" disabled />
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-12">
                                            <div class="form-group">
                                                ...
                                                <input
                                                    ...
                                                    class="form-control"
                                                    name="jenis_kelamin"
                                                    value="<?= $hasil["jenis_kelamin"] ?>" disabled />
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-12">
                                            <div class="form-group">
                                                ...
                                                <input
                                                    ...
                                                    class="form-control"
                                                    name="tanggal_lahir"
                                                    value="<?= $hasil["tanggal_lahir"] ?>" disabled />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
