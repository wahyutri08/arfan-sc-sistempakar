...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $result = addPenyakit($_POST);
    if ($result > 0) {
        echo json_encode(["status" => "success", "message" => "Data Added Successfully"]);
    } elseif ($result == -1) {
        echo json_encode(["status" => "error", "message" => "Kode Stroke Already Exists"]);
    } elseif ($result == -2) {
...
<head>
    ...
    <title>Tambah Jenis Stroke</title>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Tambah Jenis Stroke</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">DATA JENIS STROKE</h4>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="" enctype="multipart/form-data" class="form form-horizontal" data-parsley-validate id="myForm">
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label for="kode_penyakit" class="form-label">Kode Jenis <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-md-5 form-group mandatory">
                                                        <input type="text" id="kode_penyakit" class="form-control" name="kode_penyakit"
                                                            placeholder="Kode Jenis" data-parsley-required="true" />
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-5 form-group">
                                                        <input type="text" id="nama_penyakit" class="form-control" name="nama_penyakit"
                                                            placeholder="Nama Jenis Stroke" data-parsley-required="true" />
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label for="deskripsi">Deskripsi <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-md-5 form-group">
                                                        <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" data-parsley-required="true" /></textarea>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label for="solusi">Solusi <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-md-5 form-group">
                                                        <textarea class="form-control" id="solusi" name="solusi" rows="3" data-parsley-required="true" /></textarea>
                                                    </div>
