                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="">Jenis Penyakit</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">
                                <a href="add_penyakit.php" class="btn icon icon-left btn-primary"><i class="fa fa-plus"></i> Tambah Jenis Penyakit</a>
                            </h5>
                        </div>
                        <div class="card-body">
