        ...
        <div class="row h-100 d-flex">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <form action="" method="POST" class="form" data-parsley-validate id="myForm" autocomplete="off">
                        <div class="form-group position-relative has-icon-left mb-4 mandatory">
                            <input type="text" id="username" name="username" class="form-control form-control-xl" placeholder="Username" data-parsley-required="true" autocomplete="off">
                            <div class="form-control-icon">
                                <i class="bi bi-person"></i>
                            </div>
                        </div>
                        <div class="form-group position-relative has-icon-left mb-4 mandatory">
                            <input type="password" id="password" name="password" class="form-control form-control-xl" placeholder="Password" data-parsley-required="true" autocomplete="off">
                            <div class="form-control-icon">
                                <i class="bi bi-shield-lock"></i>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary btn-block btn-lg shadow-lg mt-4" id="loginBtn">
                            Log in
                        </button>
                    </form>
                </div>
            </div>
            <div class="col-lg-7 d-none d-lg-block" id="bg"></div>
        </div>
    </div>
