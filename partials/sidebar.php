    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="../dashboard"><img src="../assets/static/images/logo/logo3.png" style="width: 80px; height: 80px;" alt="Logo" srcset=""></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item <?= ($current_page == 'dashboard' || $current_page == 'index.php') ? 'active' : '' ?> ">
                    <a href="../dashboard" class='sidebar-link'>
                        <i class="bi bi-grid-fill"></i>
                        <span>Dashboard</span>
                    </a>
                </li>
                <li class="sidebar-item <?= (in_array($current_page, $master_data_pages)) ? 'active' : '' ?>  has-sub">
                    <a href="#" class='sidebar-link <?= (in_array($current_page, $master_data_pages)) ? 'submenu-open' : '' ?>'>
