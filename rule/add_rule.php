...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $result = addRule($_POST);
    if ($result > 0) {
        echo json_encode(["status" => "success", "message" => "Data Added Successfully"]);
    } elseif ($result == -1) {
        echo json_encode(["status" => "error", "message" => "Kode Rule Already Exists"]);
    } elseif ($result == -2) {
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 form-group mandatory">
                                                        <input type="text" id="kode_rule" class="form-control" name="kode_rule"
                                                            placeholder="Kode Rule" data-parsley-required="true" />
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-5 form-group">
                                                        <input type="number" id="nilai_mb" class="form-control" name="nilai_mb"
                                                            placeholder="Nilai MB (Measure of Belief)" step="0.01" data-parsley-required="true" />
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-5 form-group">
                                                        <input type="number" id="nilai_md" class="form-control" name="nilai_md"
                                                            placeholder="Nilai MD (Measure of Disbelief)" step="0.01" data-parsley-required="true" />
                                                    </div>
