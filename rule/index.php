...
$rule = query("
    ...
    JOIN gejala ON rule.id_gejala = gejala.id_gejala
    ORDER BY kode_rule ASC
");



$jumlahData = count($rule);
// Optional, kalau kamu tetap ingin tahu jumlah total data
?>
...
<head>
    ...
    <title>Rule Certainty Factor</title>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="">Rule Certainty Factor</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">
                                <a href="add_rule.php" class="btn icon icon-left btn-primary"><i class="fa fa-plus"></i> Tambah Rule</a>
                            </h5>
                        </div>
                        <div class="card-body">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                                        <a class="dropdown-item" href="edit_rule.php?id_rule=<?= $r["id_rule"]; ?>">Edit</a>
                                                        <a class="dropdown-item tombol-hapus" href="delete_rule.php?id_rule=<?= $r["id_rule"]; ?>">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
