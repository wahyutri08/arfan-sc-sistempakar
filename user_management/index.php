                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">
                                <a href="../register" class="btn icon icon-left btn-primary"><i class="fa fa-plus"></i> Tambah User</a>
                            </h5>
                        </div>
                        <div class="card-body">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                                        <a class="dropdown-item" href="edit_users.php?id=<?= $u["id"]; ?>">Edit</a>
                                                        <a class="dropdown-item tombol-hapus" href="delete_users.php?id=<?= $u["id"]; ?>">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
